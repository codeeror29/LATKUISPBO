 ...
 * @author ASUS
 */
public class RekeningPinjaman extends Rekening implements Aktivitas {
    private int saldo;
    ...
    public void tampilkanPemilik(String nama) {
        ...
        System.out.println("Pemilik Rekening Pinjaman: " + this.namaPemilik);
    }

    @Override
    public void tarikTunai(int nominal) throws InvalidNominal {
        if (nominal < 0) {
            throw new InvalidNominal("Gagal: Nominal penarikan pinjaman bernilai minus!");
        }
        if (getSaldo() - nominal < 0) {
            throw new InvalidNominal("Gagal: Saldo pinjaman tidak mencukupi!");
        }
    ...
    public void setorTunai(int nominal) throws InvalidNominal {
        if (nominal < 0) {
            throw new InvalidNominal("Gagal: Nominal penyetoran pinjaman bernilai minus!");
        }
